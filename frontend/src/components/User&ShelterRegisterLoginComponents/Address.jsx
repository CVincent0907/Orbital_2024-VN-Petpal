...
export default function Address(props) {
    ...
    return (
        <>
            ...
            <input type="text" placeholder="Address line 1" id="address" name="address" onChange={(e) => props.address1(e.target.value)}></input>
            ...
            <div className="postcode-city-field">
                <input type="text" placeholder="Postcode" id="address" name="address" onChange={(e) => props.postcode(e.target.value)}></input>
